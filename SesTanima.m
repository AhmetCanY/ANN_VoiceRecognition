%% Veri Setinin Eklenmesi
 ADS = audioDatastore('LibriSpeech/train-clean-100','IncludeSubfolders',1);
 ADS.Labels = extractBetween(ADS.Files,fullfile('LibriSpeech/train-clean-100',filesep),filesep);
